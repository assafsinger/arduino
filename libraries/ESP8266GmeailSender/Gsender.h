...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "bm90aWZpZXJAc2luZ2VyLm9yZy5pbA==";
        const char* EMAILBASE64_PASSWORD = "bm90aWZpZXIxMjM0NTY3ODkw";
        const char* FROM = "notifier@singer.org.il";
